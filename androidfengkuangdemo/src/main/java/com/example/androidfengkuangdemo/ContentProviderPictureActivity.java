...
public class ContentProviderPictureActivity extends Activity
{
    Button add;
    Button view;
    ListView show;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        view.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                SimpleAdapter simpleAdapter = new SimpleAdapter(
                        ContentProviderPictureActivity.this, listItems ,
        ...
        show.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
                    ...
                    , View source, int position, long id)
            {
                ...
                // 使用对话框显示用户单击的图片
                new AlertDialog.Builder(ContentProviderPictureActivity.this)
        ...
        add.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                Bitmap bitmap = BitmapFactory.decodeResource(
                        ContentProviderPictureActivity.this.getResources(),
                        R.drawable.jinta);
                System.out.println("======");
